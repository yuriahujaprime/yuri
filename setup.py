...
if sys.platform=="win32" or sys.platform=="cygwin":
    ...
    #
    libnames   = ["alglib315_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".dll"]
    targetname =  "alglib315_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".dll"
    dirname    = "bin-windows-intel"
else:
    libnames   = ["alglib315_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".so"]
    targetname = "alglib315_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".so"
